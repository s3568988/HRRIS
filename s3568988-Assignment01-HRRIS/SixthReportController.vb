...
Public Class SixthReportController
    ...
    Public Function findById(ByVal cId As String, ByVal mDate As Integer, ByVal yDate As Integer) As List(Of Hashtable)
        ...
        Try
            ...
            oCommand.CommandText = _
                "Select * from booking where room_id = ? and month(booking_date)= ? and year(booking_date)= ? Order by booking_id "
