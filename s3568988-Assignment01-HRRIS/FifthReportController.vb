...
Public Class FifthReportController
    ...
    Public Function findById(ByVal mDate As Integer, ByVal yDate As Integer) As List(Of Hashtable)
        ...
        Try
            ...
            oCommand.CommandText = _
                "SELECT customer.firstname, customer.lastname FROM customer, booking, room where customer.customer_id = booking.customer_id and booking.room_id = room.room_id and month(checkin_date) = ? and year(checkin_date) = ? order by booking.customer_id, checkin_date;"
            ...
            oCommand.Parameters("month(checkin_date)").Value = CInt(mDate)
            oCommand.Parameters("year(checkin_date)").Value = CInt(yDate)
    ...
    Public Sub createReport01(ByVal mDate As Integer, ByVal yDate As Integer)
        ...
        Else
            MsgBox("No booking are due for this period of time")
        End If
