...
Public Class FirstReportController
    ...
    Public Function findById(ByVal sId As String) As List(Of Hashtable)
        ...
        Try
            ...
            oCommand.CommandText = _
                "SELECT customer_id, booking_date, num_days FROM booking WHERE customer_id = ? and booking_date=(select max(booking_date) from booking WHERE customer_id = ?) Order by customer_id"
