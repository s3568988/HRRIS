...
Public Class FourthReportController
    ...
    Public Function findById(ByVal mDate As Integer, ByVal yDate As Integer) As List(Of Hashtable)
        ...
        Try
            ...
            oCommand.CommandText = _
                "Select * from booking where month(booking_date)= ? and year(booking_date)= ? "
    ...
    Public Sub createReport01(ByVal mDate As Integer, ByVal yDate As Integer)
        ...
        Else
            MsgBox("No booking was made during this period of time")
        End If
